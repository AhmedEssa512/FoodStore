...
namespace FoodStore.Data.Migrations
{
    ...
    [Migration("20250816230302_AddPricePrecisionAndTimestampsToFood")]
    partial class AddPricePrecisionAndTimestampsToFood
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodStore.Data.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodStore.Data.Entities.Cart", b =>
                {
                    b.HasOne("FoodStore.Data.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodStore.Data.Entities.CartItem", b =>
                {
                    b.HasOne("FoodStore.Data.Entities.Cart", "Cart")
                        .WithMany("Items")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodStore.Data.Entities.Food", "Food")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodStore.Data.Entities.Food", b =>
                {
                    b.HasOne("FoodStore.Data.Entities.Category", "Category")
                        .WithMany("Foods")
            ...
            modelBuilder.Entity("FoodStore.Data.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("FoodStore.Data.Entities.Order", "Order")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodStore.Data.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
